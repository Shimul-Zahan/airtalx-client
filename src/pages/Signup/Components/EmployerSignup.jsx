                    ...
                    <form onSubmit={handleSubmit(onSubmitE)}>
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='pb-2'>
                                ...
                                <input className='bg-[#f5f5f5] rounded p-2 border-slate-300 border w-full' type="password" name="password" {...register("confirmPassword")} id="" required />
                            </div>
                            <div className='pb-2'>
                                <label htmlFor="password">Role</label><br />
                                <input className='bg-[#f5f5f5] rounded p-2 border-slate-300 border w-full' type="text" value={'employer'} name="role" {...register("role")} id="" required />
                            </div>
                            <div className='pb-2'>
